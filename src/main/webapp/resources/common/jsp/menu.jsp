...
<div class="page-sidebar" id="sidebar">
    <!-- 菜单 -->
    <!-- 运营中心 -->
    <shiro:hasPermission name="O">
    <ul id="O_Menu" class="nav sidebar-menu" style="display:none;">
    	<shiro:hasPermission name="O_SMS">
        <li id="O_SMS"> 
        ...
        <shiro:hasPermission name="O_VIP">
	        <li id="O_VIP"> 
	          <a href="#" class="menu-dropdown"> 
	            ...
	            <!-- 此处为子菜单的列表，这里用class为submenu的ul标签套一层，内部结构还是如外层一样逐层嵌套 -->
	            <ul class="submenu">
	            	<shiro:hasPermission name="O_VIP_ACT">
		                <li id="O_VIP_ACT">
		                	<a href="#"  class="menu-dropdown">
		                	...
		                	<ul class="submenu">
		                		<shiro:hasPermission name="O_VIP_ACT_M010">
		                        ...
		                        <shiro:hasPermission name="O_VIP_ACT_M020">
		                        ...
		                        <shiro:hasPermission name="O_VIP_ACT_M030">
	                ...
	                <shiro:hasPermission name="O_VIP_RP">
		                <li id="O_VIP_RP">
		                	<a href="#"  class="menu-dropdown">
		                	...
		                	<ul class="submenu">
			                	<shiro:hasPermission name="O_VIP_RP_M010">
			                    	<li id="O_VIP_RP_M010">
			                           	<a href="#">
			                            	<i class="fa fa-home"></i>
		                        ...
		                        <shiro:hasPermission name="O_VIP_RP_M020">
			                        <li id="O_VIP_RP_M020">
			                        	<a href="#">
			                            	<i class="fa fa-home"></i>
		                        ...
		                        <shiro:hasPermission name="O_VIP_RP_M030">
			                        <li id="O_VIP_RP_M030">
			                        	<a href="#">
			                            	<i class="fa fa-home"></i>
		                        ...
		                        <shiro:hasPermission name="O_VIP_RP_M040">
			                        <li id="O_VIP_RP_M040">
			                        	<a href="#">
			                            	<i class="fa fa-home"></i>
		                        ...
		                        <shiro:hasPermission name="O_VIP_RP_M050">
			                        <li id="O_VIP_RP_M050">
			                        	<a href="#">
			                            	<i class="fa fa-home"></i>
		                        ...
		                        <shiro:hasPermission name="O_VIP_RP_M060">
			                        <li id="O_VIP_RP_M060">
			                        	<a href="#">
			                            	<i class="fa fa-home"></i>
	                ...
	                <shiro:hasPermission name="O_VIP_PI">
		                <li id="O_VIP_PI">
		                	<a href="#"  class="menu-dropdown">
		                	...
		                	<ul class="submenu">
			                	<shiro:hasPermission name="O_VIP_PI_M010">
			                    	<li id="O_VIP_PI_M010">
			                           	<a href="#">
			                            	<i class="fa fa-home"></i>
		                        ...
		                        <shiro:hasPermission name="O_VIP_PI_M020">
			                        <li id="O_VIP_PI_M020">
			                        	<a href="#">
			                            	<i class="fa fa-home"></i>
	                ...
	                <shiro:hasPermission name="O_VIP_COU">
		                <li id="O_VIP_COU">
		                	<a href="#"  class="menu-dropdown">
		                	...
		                	<ul class="submenu">
			                	<shiro:hasPermission name="O_VIP_COU_M010">
		                        ...
		                        <shiro:hasPermission name="O_VIP_COU_M020">
		                        ...
		                        <shiro:hasPermission name="O_VIP_COU_M030">
		                        ...
		                        <shiro:hasPermission name="O_VIP_COU_M040">
	                ...
	                <shiro:hasPermission name="O_VIP_RPT">
		                <li id="O_VIP_RPT">
		                	<a href="#"  class="menu-dropdown">
		                	...
		                	<ul class="submenu">
		                		<shiro:hasPermission name="O_VIP_RPT_M010">
    ...
    <!-- 管理中心 -->
    <shiro:hasPermission name="M">
	    <ul id="M_Menu" class="nav sidebar-menu" style="display:none;">
	    	<shiro:hasPermission name="M_VIP">
		        <li id="M_VIP"> 
		          <a href="#" class="menu-dropdown">
		            ...
		            <!-- 此处为子菜单的列表，这里用class为submenu的ul标签套一层，内部结构还是如外层一样逐层嵌套 -->
		            <ul class="submenu">
		            	<shiro:hasPermission name="M_VIP_ACT">
			                <li id="M_VIP_ACT"> 
			                	<a href="#"  class="menu-dropdown">
			                	...
			                	<ul class="submenu">
			                		<shiro:hasPermission name="M_VIP_ACT_M010">
			                        ...
			                        <shiro:hasPermission name="M_VIP_ACT_M020">
			                        ...
			                        <shiro:hasPermission name="M_VIP_ACT_M030">
			                        ...
			                        <shiro:hasPermission name="M_VIP_ACT_M040">
		                ...
		                <shiro:hasPermission name="M_VIP_RP">
			                <li id="M_VIP_RP">
								<a href="#" class="menu-dropdown"> 
								...
								<ul class="submenu">
									<shiro:hasPermission name="M_VIP_RP_M010">
				                    	<li id="M_VIP_RP_M010">
			                        ...
			                        <shiro:hasPermission name="M_VIP_RP_M020">
				                        <li id="M_VIP_RP_M020">
			                        ...
			                        <shiro:hasPermission name="M_VIP_RP_M030">
				                        <li id="M_VIP_RP_M030">
				                        	<a href="<%= BaseConstant.VIP_WEB_URL %>/vip/editPointsBillList">
				                            	<i class=""></i>
				                               	<span class="menu-text">积分调整</span>
				                           </a>
				                        </li>
						...
						<shiro:hasPermission name="M_VIP_RANK">
			                <li id="M_VIP_RANK">
								<a href="#"  class="menu-dropdown">
								...
								<ul class="submenu">
									<shiro:hasPermission name="M_VIP_RANK_M010">
			                        ...
			                        <shiro:hasPermission name="M_VIP_RANK_M020">
			                        ...
			                        <shiro:hasPermission name="M_VIP_RANK_M030">
						...
						<shiro:hasPermission name="M_VIP_CARD">
			                <li id="M_VIP_CARD">
								<a href="#" class="menu-dropdown">
								...
								<ul class="submenu">
									<shiro:hasPermission name="M_VIP_CARD_M010">
			                        ...
			                        <shiro:hasPermission name="M_VIP_CARD_M020">
			                        ...
			                        <shiro:hasPermission name="M_VIP_CARD_M030">
						...
						<shiro:hasPermission name="M_VIP_VIS">
			                <li id="M_VIP_VIS">
								<a href="#" class="menu-dropdown">
								...
								<ul class="submenu">
									<shiro:hasPermission name="M_VIP_VIS_M010">
			                        ...
			                        <shiro:hasPermission name="M_VIP_VIS_M020">
	        ...
	        <shiro:hasPermission name="M_RPM">
		        <li id="M_RPM"> 
		          <a href="#" class="menu-dropdown"> 
	        ...
	        <shiro:hasPermission name="M_UMCB">
		        <li id="M_UMCB"> 
		          <a href="#" class="menu-dropdown"> 
		            ...
		            <!-- 此处为子菜单的列表，这里用class为submenu的ul标签套一层，内部结构还是如外层一样逐层嵌套 -->
		            <ul class="submenu">
		            	<shiro:hasPermission name="M_UMCB_BRA">
			                <li id="M_UMCB_BRA">
			                	<a href="#" class="menu-dropdown">
			                	...
			                	<ul class="submenu">
			                		<shiro:hasPermission name="M_UMCB_BRA_M010">
			                        ...
			                        <shiro:hasPermission name="M_UMCB_BRA_M020">
			                        ...
			                        <shiro:hasPermission name="M_UMCB_BRA_M030">
		                ...
		                <shiro:hasPermission name="M_UMCB_OU">
			                <li id="M_UMCB_OU">
			                	<a href="#" class="menu-dropdown">
			                	...
			                	<ul class="submenu">
			                		<shiro:hasPermission name="M_UMCB_OU_M010">
			                        ...
			                        <shiro:hasPermission name="M_UMCB_OU_M020">
			                        ...
			                        <shiro:hasPermission name="M_UMCB_OU_M030">
		                ...
		                <shiro:hasPermission name="M_UMCB_USER">
			                <li id="M_UMCB_USER">
			                	<a href="#" class="menu-dropdown">
			                	...
			                	<ul class="submenu">
			                		<shiro:hasPermission name="M_UMCB_USER_M010">
			                        ...
			                        <shiro:hasPermission name="M_UMCB_USER_M020">
	        ...
	        <shiro:hasPermission name="M_MSGC">
		        <li id="M_MSGC"> 
		          <a href="#" class="menu-dropdown"> 
		            ...
		            <!-- 此处为子菜单的列表，这里用class为submenu的ul标签套一层，内部结构还是如外层一样逐层嵌套 -->
		            <ul class="submenu">
		            	<shiro:hasPermission name="M_MSGC_M010">
		                	<li id="M_MSGC_M010"> <a href="<%= BaseConstant.MSGC_WEB_URL %>/msgmgr/msgSendLogList"> <span class="menu-text">消息日志</span> </a> </li>
		                </shiro:hasPermission>
		                <shiro:hasPermission name="M_MSGC_M020">
		                	<li id="M_MSGC_M020"> <a href="<%= BaseConstant.MSGC_WEB_URL %>/msgmgr/msgTemplate"> <span class="menu-text">消息模板</span> </a> </li>
		                </shiro:hasPermission>
		                <shiro:hasPermission name="M_MSGC_M030">
		                	<li id="M_MSGC_M030"> <a href="<%= BaseConstant.MSGC_WEB_URL %>/msgmgr/smsAccount"> <span class="menu-text">短信账户</span> </a> </li>
		                </shiro:hasPermission>
		            </ul>
		        </li>
	        </shiro:hasPermission>
    ...
    <!-- 平台管理 -->
    <shiro:hasPermission name="P">
	     <ul id="P_Menu" class="nav sidebar-menu" style="display:none;">
	     	<shiro:hasPermission name="P_UMCP">
		        <li id="P_UMCP"> 
		          <a href="#" class="menu-dropdown">
		          	<i class="menu-icon fa fa-home"></i> 
		            ...
		            <ul class="submenu"> 
		                ...
		                <shiro:hasPermission name="P_UMCP_SMS">
		                	<li id="P_UMCP_SMS">
			                	...
			                	<ul class="submenu">
			                		<shiro:hasPermission name="P_UMCP_SMS_M010">
				                    	<li id="P_UMCP_SMS_M010">
				                           	<a href="<%= BaseConstant.UMC_WEB_URL %>/smsGateway">
				                            	<i class="fa fa-home"></i>
				                                <span class="menu-text">短信网关</span>
				                            </a>
				                        </li>
			                        </shiro:hasPermission>
			                        <shiro:hasPermission name="P_UMCP_SMS_M020">
			                        ...
			                        <shiro:hasPermission name="P_UMCP_SMS_M030">
				                        <li id="P_UMCP_SMS_M030">
				                        	<a href="<%= BaseConstant.UMC_WEB_URL %>/smsActRechargeHis">
				                            	<i class="fa fa-home"></i>
	         ...
	         <shiro:hasPermission name="P_UIM">
		        <li id="P_UIM"> 
		          <a href="#" class="menu-dropdown"> 
		          	<i class="menu-icon fa fa-home"></i> 
