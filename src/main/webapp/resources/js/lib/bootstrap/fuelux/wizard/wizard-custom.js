(function(b, c) {
    ...
    a.prototype = {
        ...
        setState: function() {
            ...
            this.$prevBtn && this.$prevBtn.attr("disabled", (o === true || n === false));
            this.$nextBtn && this.$nextBtn.attr('disabled', (n === true && d === true));
            var h = this.$nextBtn && this.$nextBtn.data();
            if (h && h.last) {
                this.lastText = h.last;
                if (typeof this.lastText !== "undefined") {
                    var l = (d !== true) ? this.nextText : this.lastText;
                    var f = this.$nextBtn && this.$nextBtn.children().detach();
                    this.$nextBtn && this.$nextBtn.text(l).append(f)
                }
            }
