...
(function (n, t, i) {
    var r = function (r) {
        "use strict";
        var f = {
            version: "1.0.4-TableTools2", clients: {}, moviePath: "", nextId: 1, $: function (n) {
        ...
        return f.Client.prototype = {
            ...
            positionElement: function () {
                var n = f.getDOMObjectPosition(this.domElement), t = this.div.style, i;
                if (t.position = "absolute", t.width = n.width + "px", t.height = n.height + "px", n.width !== 0 && n.height !== 0)this.sized = !0; else return;
            ...
            reposition: function (n) {
                if (n && (this.domElement = f.$(n), this.domElement || this.hide()), this.domElement && this.div) {
                    var t = f.getDOMObjectPosition(this.domElement), i = this.div.style;
                    i.left = "" + t.left + "px";
                    i.top = "" + t.top + "px"
                }
            },
            ...
            u = function (t, i) {
                !this instanceof u && alert("Warning: TableTools must be initialised with the keyword 'new'");
                ...
                }, this.classes = n.extend(!0, {}, u.classes), this.s.dt.bJUI && n.extend(!0, this.classes, u.classes_themeroller), this.fnSettings = function () {
                    return this.s
                }, typeof i == "undefined" && (i = {}), this._fnConstruct(i), this
            };
            u.prototype = {
                fnGetSelected: function (n) {
                    var u = [], i = this.s.dt.aoData, f = this.s.dt.aiDisplay, t, r;
                    if (n)for (t = 0, r = f.length; t < r; t++)i[f[t]]._DTTT_selected && u.push(i[f[t]].nTr); else for (t = 0, r = i.length; t < r; t++)i[t]._DTTT_selected && u.push(i[t].nTr);
                    return u
                    ...
                    this.s.custom = n.extend({}, u.DEFAULTS, t);
                    ...
                    return n.sAction.match(/flash/) ? this._fnFlashConfig(i, n) : n.sAction == "text" ? this._fnTextConfig(i, n) : n.sAction == "div" ? this._fnTextConfig(i, n) : n.sAction == "collection" && (this._fnTextConfig(i, n), this._fnCollectionConfig(i, n)), i
                    ...
                    var i = r.createElement(u), o = r.createElement(f), s = this._fnGetMasterSettings();
                    ...
                    var a = this, v = n(i).offset(), f = u._collection, y = v.left, s = v.top + n(i).outerHeight(), p = n(t).height(), h = n(r).height(), w = n(t).width(), o = n(r).width(), e, c, l;
                    ...
                    setTimeout(function () {
                        n(f).animate({opacity: 1}, 500);
                        n(e).animate({opacity: .25}, 500)
                    }, 10);
                    ...
                    (i === null || i.sExtends != "collection") && this.dom.collection.collection !== null && (n(this.dom.collection.collection).animate({opacity: 0}, 500, function () {
                        this.style.display = "none"
                    }), n(this.dom.collection.background).animate({opacity: 0}, 500, function () {
                        this.parentNode.removeChild(this)
                    }), this.dom.collection.collection = null, this.dom.collection.background = null)
                }, _fnRowSelectConfig: function () {
                    if (this.s.master) {
                        var t = this, i = this.s.dt, r = this.s.dt.aoOpenRows;
                        ...
                        n(i.nTBody).on("click.DTTT_Select", "tr", function (r) {
                            var f = t.s.select, o = t.s.dt.oInstance.fnGetPosition(this), h;
                            if (this.parentNode == i.nTBody && i.oInstance.fnGetData(this) !== null) {
                                if (f.type == "os")if (r.ctrlKey || r.metaKey)t.fnIsSelected(this) ? t._fnRowDeselect(this, r) : t._fnRowSelect(this, r); else if (r.shiftKey) {
                                    var u = t.s.dt.aiDisplay.slice(), e = n.inArray(f.lastRow, u), s = n.inArray(o, u);
                                ...
                                } else t.fnIsSelected(this) && t.fnGetSelected().length === 1 ? t._fnRowDeselect(this, r) : (t.fnSelectNone(), t._fnRowSelect(this, r)); else t.fnIsSelected(this) ? t._fnRowDeselect(this, r) : f.type == "single" ? (t.fnSelectNone(), t._fnRowSelect(this, r)) : f.type == "multi" && t._fnRowSelect(this, r);
                                f.lastRow = o
                            }
                        });
                    ...
                    for (var s = this, f = this._fnSelectData(t), h = f.length === 0 ? null : f[0].nTr, e = [], r = 0, o = f.length; r < o; r++)f[r].nTr && e.push(f[r].nTr);
                    if (this.s.select.preRowSelect === null || this.s.select.preRowSelect.call(this, i, e, !0)) {
                        for (r = 0, o = f.length; r < o; r++)f[r]._DTTT_selected = !0, f[r].nTr && n(f[r].nTr).addClass(s.classes.select.row);
                    ...
                    if (this.s.select.preRowSelect === null || this.s.select.preRowSelect.call(this, i, e, !1)) {
                        for (r = 0, o = f.length; r < o; r++)f[r]._DTTT_selected = !1, f[r].nTr && n(f[r].nTr).removeClass(s.classes.select.row);
                    ...
                    var i = [], r, t, u;
                    if (n.nodeName)r = this.s.dt.oInstance.fnGetPosition(n), i.push(this.s.dt.aoData[r]); else {
                    ...
                    i.fnSelect !== null && u._fnEventListen(this, "select", function (n) {
                    ...
                    var u = this, f = t.getAttribute("id");
                    r.getElementById(f) ? n.glue(t, i) : setTimeout(function () {
                        u._fnFlashGlue(n, t, i)
                    }, 100)
                }, _fnFlashSetText: function (n, t) {
                    var r = this._fnChunkData(t, 8192), i, u;
                    for (n.clearText(), i = 0, u = r.length; i < u; i++)n.appendText(r[i])
                }, _fnColumnTargets: function (n) {
                    var u = [], r = this.s.dt, t, i;
                    if (typeof n == "object") {
                        for (t = 0, i = r.aoColumns.length; t < i; t++)u.push(!1);
                        for (t = 0, i = n.length; t < i; t++)u[n[t]] = !0
                    } else if (n == "visible")for (t = 0, i = r.aoColumns.length; t < i; t++)u.push(r.aoColumns[t].bVisible ? !0 : !1); else if (n == "hidden")for (t = 0, i = r.aoColumns.length; t < i; t++)u.push(r.aoColumns[t].bVisible ? !1 : !0); else if (n == "sortable")for (t = 0, i = r.aoColumns.length; t < i; t++)u.push(r.aoColumns[t].bSortable ? !0 : !1); else for (t = 0, i = r.aoColumns.length; t < i; t++)u.push(!0);
                    return u
                }, _fnNewline: function (n) {
                    return n.sNewLine == "auto" ? navigator.userAgent.match(/Windows/) ? "\r\n" : "\n" : n.sNewLine
                }, _fnGetDataTablesData: function (t) {
                    var r, e, o, b, f, s = [], i = "", a, u = this.s.dt, v, l = new RegExp(t.sFieldBoundary, "g"), y = this._fnColumnTargets(t.mColumns), p = typeof t.bSelectedOnly != "undefined" ? t.bSelectedOnly : !1, w, h, c;
                    if (t.bHeader) {
                    ...
                    for (w = this.fnGetSelected(), p = this.s.select.type !== "none" && p && w.length !== 0, h = u.oInstance.$("tr", t.oSelectorOpts).map(function (t, i) {
                        ...
                        s.push(f.join(t.sFieldSeperator));
                        t.bOpenRows && (a = n.grep(u.aoOpenRows, function (n) {
                            return n.nParent === v
                    ...
                    var s = this, u = this.s.dt, e, f, o, h;
                    ...
                    var e = this, i = this.s.dt, u = this.s.print, f = this.dom.print;
                    ...
                    var t = this.s.dt, f = t.nScrollHead.getElementsByTagName("div")[0], e = f.getElementsByTagName("table")[0], u = t.nTable.parentNode, i, r;
                    ...
                    var n = this.s.dt, t = n.nTable.parentNode;
            ...
            u.fnGetInstance = function (n) {
                ...
                for (var t = 0, i = u._aInstances.length; t < i; t++)if (u._aInstances[t].s.master && u._aInstances[t].dom.table == n)return u._aInstances[t];
                return null
            };
            u._fnEventListen = function (n, t, i) {
                u._aListeners.push({that: n, type: t, fn: i})
            };
            u._fnEventDispatch = function (n, t, i, r) {
                for (var e = u._aListeners, f = 0, o = e.length; f < o; f++)n.dom.table == e[f].that.dom.table && e[f].type == t && e[f].fn(i, r)
            };
            u.buttonBase = {
                sAction: "text",
                sTag: "default",
            ...
            u.BUTTONS = {
                ...
                copy: n.extend({}, u.buttonBase, {
                    ...
                    fnComplete: function (n, t, i, r) {
                        var u = r.split("\n").length, f = this.s.dt.nTFoot === null ? u - 1 : u - 2, e = f == 1 ? "" : "s";
                        this.fnInfo("<h6>Table copied<\/h6><p>Copied " + f + " row" + e + " to the clipboard.<\/p>", 1500)
                    }
                }),
                pdf: n.extend({}, u.buttonBase, {
                    sAction: "flash_pdf",
                    sNewLine: "\n",
                    sFileName: "*.pdf",
                ...
                text: n.extend({}, u.buttonBase),
                select: n.extend({}, u.buttonBase, {
                ...
                select_single: n.extend({}, u.buttonBase, {
                    sButtonText: "Select button", fnSelect: function (t) {
                ...
                select_all: n.extend({}, u.buttonBase, {
                ...
                select_none: n.extend({}, u.buttonBase, {
                ...
                div: n.extend({}, u.buttonBase, {
                    sAction: "div",
                    sTag: "div",
                    sButtonClass: "DTTT_nonbutton",
                    sButtonText: "Text button"
                }),
                collection: n.extend({}, u.buttonBase, {
                    sAction: "collection",
            ...
            n.fn.dataTable.Api && n.fn.dataTable.Api.register("tabletools()", function () {
                var n = null;
                return this.context.length > 0 && (n = u.fnGetInstance(this.context[0].nTable)), n
            });
            typeof n.fn.dataTable == "function" && typeof n.fn.dataTableExt.fnVersionCheck == "function" && n.fn.dataTableExt.fnVersionCheck("1.9.0") ? n.fn.dataTableExt.aoFeatures.push({
                fnInit: function (n) {
                    var t = n.oInit, r = t.tableTools || t.oTableTools || {}, i = new u(n.oInstance, r);
                    return u._aInstances.push(i), i.dom.container
            ...
            fnInit: function (n) {
                var i = typeof n.oInit.oTableTools != "undefined" ? n.oInit.oTableTools : {}, t = new u(n.oInstance, i);
                return u._aInstances.push(t), t.dom.container
            }, cFeature: "T", sFeature: "TableTools"
        }) : alert("Warning: TableTools 2 requires DataTables 1.9.0 or newer - www.datatables.net/download"), r.fn.dataTable.TableTools = u, r.fn.DataTable.TableTools = u, u
    };
