...
(function (a) {
    ...
    function cs(b, d, e, f, h, i) {
        ...
        if (f)for (y = 0, z = cm.length; y < z; y++) {
            var x = cm[y];
    ...
    var bn = function (b) {
        ...
        b *= 255, c *= 255, d *= 255;
        var f = {r: b, g: c, b: d, hex: a.rgb(b, c, d), toString: bq};
        a.is(e, "finite") && (f.opacity = e);
        return f
    };
    a.color = function (b) {
        var c;
        a.is(b, "object") && "h"in b && "s"in b && "b"in b ? (c = a.hsb2rgb(b), b.r = c.r, b.g = c.g, b.b = c.b, b.hex = c.hex) : a.is(b, "object") && "h"in b && "s"in b && "l"in b ? (c = a.hsl2rgb(b), b.r = c.r, b.g = c.g, b.b = c.b, b.hex = c.hex) : (a.is(b, "string") && (b = a.getRGB(b)), a.is(b, "object") && "r"in b && "g"in b && "b"in b ? (c = a.rgb2hsl(b), b.h = c.h, b.s = c.s, b.l = c.l, c = a.rgb2hsb(b), b.v = c.b) : (b = {hex: "none"}, b.r = b.g = b.b = b.h = b.s = b.v = b.l = -1)), b.toString = bq;
        return b
        ...
        return {h: d, s: e, b: f, toString: bo}
        ...
        return {h: d, s: e, l: f, toString: bp}
    ...
    a.getRGB = bu(function (b) {
        if (!b || !!((b = r(b)).indexOf("-") + 1))return {r: -1, g: -1, b: -1, hex: "none", error: 1, toString: bw};
        if (b == "none")return {r: -1, g: -1, b: -1, hex: "none", toString: bw};
        ...
        return {r: -1, g: -1, b: -1, hex: "none", error: 1, toString: bw}
    ...
    var by = bu(function (a) {
        ...
        c.toString = a._path2string;
        return c
    }, 0, bz), bB = a._pathToAbsolute = bu(function (b) {
        if (!a.is(b, E) || !a.is(b && b[0], E))b = a.parsePathString(b);
        ...
        for (var j, k, l = h, m = b.length; l < m; l++) {
            ...
            } else if (k[0] == "R")o = [d, e][n](k.slice(1)), c.pop(), c = c[n](bx(o, i)), j = ["R"][n](k.slice(-2)); else for (var r = 0, s = k.length; r < s; r++)j[r] = k[r];
            switch (j[0]) {
                case"Z":
                    d = f, e = g;
                    break;
        ...
        c.toString = a._path2string;
        return c
    }, null, bz), bC = function (a, b, c, d) {
        return [a, b, c, d, c, d]
    }, bD = function (a, b, c, d, e, f) {
        var g = 1 / 3, h = 2 / 3;
        return [g * a + h * c, g * b + h * d, g * e + h * c, g * f + h * d, e, f]
    }, bE = function (a, b, c, d, e, f, g, h, i, j) {
        var k = B * 120 / 180, l = B / 180 * (+e || 0), m = [], o, p = bu(function (a, b, c) {
        ...
        var c = bB(a), d = b && bB(b), e = {x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null}, f = {
            x: 0,
            y: 0,
            bx: 0,
            by: 0,
        ...
        return d ? [c, d] : c
    }, null, bz), bI = a._parseDots = bu(function (b) {
        var c = [];
        for (var d = 0, e = b.length; d < e; d++) {
            var f = {}, g = b[d].match(/^([^:]*):?([\d\.]*)/);
    ...
    b_.drag = function (b, c, d, e, f, g) {
        ...
        this._drag = {}, cb.push({el: this, start: i}), this.mousedown(i);
        return this
    ...
    var cf = {}, cg = function (b, c, d, e, f, g, h, i, j) {
        var k = 0, l = 100, m = [b, c, d, e, f, g, h, i].join(), n = cf[m], o, p;
        !n && (cf[m] = n = {data: []}), n.timer && clearTimeout(n.timer), n.timer = setTimeout(function () {
            delete cf[m]
        }, 2e3);
    ...
    var cm = [], cn = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (a) {
            setTimeout(a, 16)
        }, co = function () {
        var b = +(new Date), c = 0;
        for (; c < cm.length; c++) {
    ...
    b_.animateWith = function (b, c, d, e, f, g) {
        ...
        var i = d instanceof cr ? d : a.animation(d, e, f, g), j, k;
        cs(i, h, i.percents[0], null, h.attr());
        for (var l = 0, m = cm.length; l < m; l++)if (cm[l].anim == c && cm[l].el == b) {
        ...
        for (var b = 0; b < cm.length; b++)if (cm[b].el.id == this.id && (!a || cm[b].anim == a)) {
            var c = cm[b];
    ...
    var ct = function (a) {
        ...
        if (a)for (var b = 0, c = a.length; b < c; b++)a[b] && (a[b].constructor == b_.constructor || a[b].constructor == ct) && (this[this.items.length] = this.items[this.items.length] = a[b], this.length++)
    }, cu = ct.prototype;
    cu.push = function () {
        var a, b;
