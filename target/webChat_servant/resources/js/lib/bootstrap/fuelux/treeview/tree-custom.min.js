!function (n) {
    ...
    t.prototype = {
        constructor: t, render: function () {
            ...
            var i = this, r = t.parent(), u = r.find(".tree-loader:eq(0)");
            u.show();
            ...
            var i = n(t), u = this.$element.find(".tree-selected"), r = [], f;
            ...
            r.length && this.$element.trigger("selected", {info: r});
            i.trigger("updated", {info: r, item: i, eventType: f})
        }, selectFolder: function (t) {
            var r, u, f, i = n(t), o = i.parent(), s = o.find(".tree-folder-content"), e = s.eq(0);
            ...
            var i = this.$element.find(".tree-selected"), t = [];
            ...
            this.$element.find(".fa.fa-folder-open").each(function () {
                var r = n(this).removeClass("fa fa-folder fa-folder-open").addClass("fa fa-folder"), u = r.parent().parent(), i = u.children(".tree-folder-content");
                i.hide();
                t || i.empty()
            })
        }
    ...
    n.fn.tree = function (i, r) {
        var u, f = this.each(function () {
            var e = n(this), f = e.data("tree"), o = "object" == typeof i && i;
            f || e.data("tree", f = new t(this, o));
            "string" == typeof i && (u = f[i](r))
        });
        return void 0 === u ? f : u
    };
    n.fn.tree.defaults = {selectable: !0, multiSelect: !1, loadingHTML: "<div>Loading...<\/div>", cacheItems: !0};
